...
const generateInvoiceForVendor = async (order_id, vendor_id) => {
  try {
    ...
    throw new Error("Error generating vendor invoice");
  }
};
...
const downloadVendorInvoice = async (req, res) => {
  ...
  try {
    const filePath = await generateInvoiceForVendor(order_id, vendor_id);
