...
const softDeleteCategory = async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({ message: "Category and associated items soft deleted successfully" });
  } catch (error) {
...
module.exports = { addCategory, getAllCategories, softDeleteCategory,updateCategory };
